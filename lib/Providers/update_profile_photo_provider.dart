  ...
  Future<UserProfileUpdatePhotoResponse?> updateprofilephoto(
    ...
    try {
      ...
      if (token == null || token.isEmpty) {
        failure('Error in updateprofilephoto', 'Token not found');
        return null;
      }
      ...
      if (response.statusCode == null || response.body == null) {
        failure('Error in updateprofilephoto', 'Server Failed To Respond');
        return null;
      }
      ...
      if (response.statusCode == 200) {
        if (response.body['error']['code'] == 0) {
          ...
          failure('Error in updateprofilephoto', response.body['error']['message']);
          return null;
        }
      } else {
      ...
      failure('Error in updateprofilephoto', e.toString());
      return null;
    }
  }
}
