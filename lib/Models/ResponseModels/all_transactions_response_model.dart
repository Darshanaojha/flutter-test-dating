...
class Transaction {
  ...
  factory Transaction.fromJson(Map<String, dynamic> json) {
    return Transaction(
      ...
      userId:
          json['user_id'] ?? '', // Default to empty string if user_id is null
      orderId:
          json['order_id'] ?? '', // Default to empty string if order_id is null
      packageId: json['package_id'] ??
          '', // Default to empty string if package_id is null
      ...
      paymentStatus: json['payment_status'] ??
          '', // Default to empty string if payment_status is null
      ...
      created:
          json['created'] ?? '', // Default to empty string if created is null
      updated:
          json['updated'] ?? '', // Default to empty string if updated is null
      coin: json['coin'] ?? '', // Default to empty string if coin is null
    );
  }
}
