...
class _HomePageState extends State<HomePage> {
  ...
  final FocusNode _pingFocusNode = FocusNode(); // FocusNode to manage the input focus
  ...
  @override
  void dispose() {
    _pingFocusNode.dispose(); // Don't forget to dispose of the FocusNode
    super.dispose();
  }
...
void _showPingBottomSheet() {
  Get.bottomSheet(
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              focusNode: _pingFocusNode, // Assigning the focus node
    ...
    enterBottomSheetDuration: Duration(milliseconds: 300), // Optional animation duration
    exitBottomSheetDuration: Duration(milliseconds: 300), // Optional exit animation duration
  );
}
        ...
        children: [
          ...
          if (_isLoading)
            Center(
              child: CircularProgressIndicator(
                valueColor:
                    AlwaysStoppedAnimation<Color>(AppColors.acceptColor),
                strokeWidth: 6.0,
              ),
            ),
          Positioned(
